...
int segy_field_data_int( const segy_field_data* fd, int* val );
...
typedef enum {
    ...
    SEGY_BIN_INTEGER_CONSTANT       = 3297, // Expected value 0x04030201 Used to detect order of bytes
    ...
    SEGY_BIN_MAX_ADD_TRACE_HEADERS  = 3507,
    SEGY_BIN_SURVEY_TYPE            = 3509,
    SEGY_BIN_TIME_BASIC_CODE        = 3511,
