...
def open_in_memory(memory_buffer,
                   iline=189,
                   xline=193,
                   strict=True,
                   ignore_geometry=False,
    ...
    Function behaves the same as `segyio.open`, but expects file to fit fully
    into memory. Performance is expected to be significantly faster than using
    `segyio.open` or `segyio.open_with`.
