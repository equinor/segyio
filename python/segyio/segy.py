...
from .trace import TraceHeaderLayoutSequence, TracesTraceHeaderSequence
...
class SegyFile(object):
    ...
    def __init__(
        ...
        self._traceheader = TracesTraceHeaderSequence(self)
        self._iline = None
        self._xline = None
        self._gather = None
        self.depth = None
    ...
    def tracefield(self):
        ...
        Returns
        -------
        tracefield : TraceHeaderLayoutSequence
        ...
        - use :meth:`.traceheader` if you need to get many fields from the
          trace.
        ...
        .. versionadded:: 2.0
        """
        return TraceHeaderLayoutSequence(self)
    ...
    def header(self, val):
        ...
        use the default full-file range.  It will write headers 0, 1, ..., n,
        but uses the iteration specified by the right-hand side (i.e. can skip
        headers etc).
