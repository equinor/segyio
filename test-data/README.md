...
| broken.sgy                     | File that cannot be open via segyio.                                        |                                                       | File ending is cut out                     |
...
| mapping-unparsable-lsb.sgy     | XML is not ascii. Not related to 'mapping-unparsable.sgy'     |
